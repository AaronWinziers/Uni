...
\section*{Fragen für lernen}
\subsection*{Welche Probleme gibt es bei der Digitalisierung traditioneller Bibliotheken?}
	\begin{itemize}
		\item Scanqualität
		\begin{itemize}
			\item Auflösung
			\item Format
		\end{itemize}
		\item Schrifterkennung
		\begin{itemize}
			\item Buchstabenerkennung (Schwierig bei "exotische Schriftarten")
			\item Worterkennung ()Schwer bei seltene Sprachen/ Spezialvokabular
		\end{itemize}
	\end{itemize}

\subsection*{Welche Publikationsmöglichkeiten gibt es? (Ablauf)}
	\begin{itemize}
		\item Workshop
		\item Konferenzen
		\item Zeitschriften
...
\subsection*{Nennen sie ein paar mögliche Retrieval-Szenarien}
	\begin{itemize}
		\item Empfehlungen
		\item Bildersuche
		\item Question answering
		\item Desktop-Suche
		\item Ortsabhängige Suche
		\item Adhoc-Suche
	\end{itemize}
	
\subsection*{Erklären Sie Proximity-Queries}

\subsection*{Welche Ansätze gibt es zur Rechtschreibkorrektur?}
	\begin{itemize}
		\item Korrektur isolierter Terme
		\item Kontext-sensitive Korrektur
		\item Phonetische Korrektur
	\end{itemize}

\subsection*{Wozu werden Sprachmodelle verwendet?}
...
\subsection*{Erklären sie das Probability Ranking Principle}
